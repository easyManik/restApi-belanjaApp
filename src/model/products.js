...
const sortData = (sortby, sort, page, limit) => Pool.query(
...
const getData = () => Pool.query(
  'SELECT products.name AS product_name, products.price AS harga, category.name AS category_name FROM products JOIN category ON products.category_id = category.id',
);

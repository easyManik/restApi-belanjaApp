...
const selectData = () => Pool.query('SELECT * FROM transactions');

const insertData = (data) => {
  const {
    id, email, products_id, amount, total, status,
  } = data;
